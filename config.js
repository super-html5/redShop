...
var config = {
        ...
        getUserCoupon: `${host}/api/v1/wine/userCoupon/getUserCoupon`,//查看所有优惠券
        getUserCanUseCoupon: `${host}/api/v1/wine/userCoupon/getUserCouponByPrice`,//查看可用优惠券

        findOrderById: `${host}/api/v1/wine/orders/findById`,
        ...
        cancelOrderUrl: `${host}/api/v1/wine/orders/cancel`,//订单取消
        deleteOrderUrl: `${host}/api/v1/wine/orders/delete`,//订单删除
        ...
        selfRaiseStationUrl: `${host}/api/v1/wine/selfRaiseStation/list`, //查看自提点
        finishOrderUrl: `${host}/api/v1/wine/orders/finish`,//确认收货
        coverImgUrl: `${host}/api/v1/wine/common/find/coverImgUrl/configKey`, //封面图
        protocolContentUrl: `${host}/api/v1/wine/common/find/protocolContent/configKey`, //用户协议
